...
6. РЕАЛИЗМ ОПИСАНИЙ:
   - Описание компании (поле "description") — ровно 2-3 предложения:
     * 1-е предложение: чем занимается компания и её ниша
     * 2-е предложение: масштаб (аудитория, объём, география)
     * 3-е предложение: роль IT в бизнесе компании
     * Пример: "Крупный российский маркетплейс электроники и бытовой техники. Обслуживает более 5 млн активных покупателей в 60 городах России. Весь бизнес построен на собственной IT-платформе с высокими требованиями к доступности и скорости."
...
_REGEN_FIELD_HINTS = {
    ...
    "description": "Опиши компанию или проект в 2-3 предложениях: 1) чем занимается и её ниша, 2) масштаб и аудитория, 3) роль IT в бизнесе.",
