...
0. ИМЯ КАНДИДАТА — если в промпте не указано конкретное имя, генерируй разнообразные реалистичные русские имена и фамилии:
   - Используй разные имена: Алексей, Дмитрий, Сергей, Андрей, Михаил, Иван, Артём, Никита, Павел, Евгений, Роман, Кирилл, Максим, Владимир, Антон, Илья
   - Разные фамилии: Козлов, Новиков, Морозов, Волков, Лебедев, Семёнов, Егоров, Павлов, Степанов, Фёдоров, Орлов, Соколов, Попов, Зайцев, Борисов, Тихонов
   - Формат: "Имя Фамилия" (без отчества, допустимо сокращение фамилии до первой буквы: "Алексей К.")
   - НЕ повторяй одни и те же имена — каждый CV должен быть уникальным
...
5. РАЗМЕР КОМАНДЫ — определяй исходя из сложности и масштаба конкретного проекта:
   - Небольшой внутренний инструмент / стартап: 2-5 человек
   - Средний продукт (B2B SaaS, корпоративная система): 5-12 человек
   - Крупный потребительский сервис (маркетплейс, портал): 10-25 человек
   - Высоконагруженная платформа федерального масштаба: 20-40 человек
   - Указывай конкретные роли только если они реально нужны в этом проекте (не добавляй DevOps в простой CRUD-сервис)
